...
<div class="mb-6">
    ...
    <h2 class="mt-2 text-2xl font-bold text-gray-900">Editar Restaurante</h2>
</div>

<div class="max-w-2xl rounded-lg bg-white p-6 shadow">
    <form method="POST" action="{{ route('admin.restaurantes.update', $restaurante->id) }}">
        @csrf
        @method('PUT')
        ...
        <div class="mb-4">
            ...
            <input
                ...
                id="cnpj"
                name="cnpj"
                value="{{ old('cnpj', $restaurante->cnpj) }}"
        ...
        <div class="mb-4">
            ...
            <input
                ...
                id="email"
                name="email"
                value="{{ old('email', $restaurante->email) }}"
        ...
        <div class="mb-6">
            ...
            <input
                ...
                id="endereco"
                name="endereco"
                value="{{ old('endereco', $restaurante->endereco) }}"
                class="mt-1 w-full rounded-lg border border-gray-300 px-4 py-2"
            />
        </div>
        ...
        <div class="mb-6">
            <label for="status" class="flex items-center gap-2">
                <input
                    ...
                    name="status"
                    value="1"
                    {{ old('status', $restaurante->status) ? 'checked' : '' }}
                    class="rounded"
                />
